...
import { createUserValidator, loginUserValidator } from "../utils/validators";
...
// Route definitions
authRouter.post("/login", loginUserValidator, signIn); // POST /auth/login - Logs in a user
authRouter.post("/register", createUserValidator, signUp); // POST /auth/register - Registers a new user
authRouter.post("/logout", signOut); // POST /auth/logout - Logs out a user
